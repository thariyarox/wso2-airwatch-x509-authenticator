...
<%!
    ...
    private static final String AIRWATCH_X509_AUTHENTICATOR = "AirWatchX509";
                ...
                <div class="container col-xs-10 col-sm-6 col-md-6 col-lg-3 col-centered wr-content wr-login col-centered">
                    ...
                    <div class="boarder-all ">
                        ...
                        <div class="padding-double login-form">
                            ...
                            <%
                            } else if (localAuthenticatorNames.size() > 0 && localAuthenticatorNames.contains(AIRWATCH_X509_AUTHENTICATOR)) {
